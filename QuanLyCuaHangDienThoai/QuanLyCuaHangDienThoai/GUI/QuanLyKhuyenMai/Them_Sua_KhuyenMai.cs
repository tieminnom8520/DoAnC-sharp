...
{
    public partial class Them_Sua_KhuyenMai : Form
    {
        public KhuyenMaiBUS km_bus;
        QuanLyKhuyenMaiFrm qlkm_form;
        bool capnhat;
        public Them_Sua_KhuyenMai()
        {
            InitializeComponent();
        }
        public Them_Sua_KhuyenMai(QuanLyKhuyenMaiFrm qlkm_form,KhuyenMaiBUS km_bus, bool capnhat = false)
        {
